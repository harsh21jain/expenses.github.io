                ...
                <div class="col-12 col-sm-8 col-md-6 col-lg-5 col-xl-4">
                    <div class="bg-light rounded p-4 p-sm-5 my-4 mx-3">
                        ...
                        <form method="post">
                            ...
                            <input type="submit" name="submit" class="btn btn-primary py-3 w-100 mb-4" value="Login"/>
                        </form>
                        <p class="text-center mb-0">Don't have an Account? <a href="<?php echo base_url('register'); ?>">Sign Up</a></p>
                    </div>
                </div>
            </div>
        </div>
